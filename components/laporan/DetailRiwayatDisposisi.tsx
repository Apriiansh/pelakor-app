...
interface DetailDisposisiDialogProps {
    visible: boolean;
...
export const DetailDisposisiDialog = ({
    visible,
    laporan,
    disposisiHistory,
    tindakLanjutHistory,
...
const getStyles = (theme: ReturnType<typeof useAppTheme>['theme']) => StyleSheet.create({
    dialog: {
        maxHeight: '80%',
        width: '92%',
        alignSelf: 'center',
